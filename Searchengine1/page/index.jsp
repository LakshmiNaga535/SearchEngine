...
<link rel="stylesheet" type="text/css" href="page/jquery.autocomplete.css" />
    <script type="text/javascript"
            src="page/jquery.min.js"></script>
    <script src="page/jquery.autocomplete.js"></script>
<style type="text/css">
...
<body>
	...
	<form action="search" method="post" id="form1">
		...
		<script>
        $("#query").autocomplete("page/list.jsp");
    </script>
